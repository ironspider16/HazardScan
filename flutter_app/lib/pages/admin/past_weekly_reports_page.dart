...
class AllWeeklyReportsPage extends StatefulWidget {
  const AllWeeklyReportsPage({super.key});

  @override
  State<AllWeeklyReportsPage> createState() => PastWeeklyReportsPageState();
}

class PastWeeklyReportsPageState extends State<AllWeeklyReportsPage> {
  ...
  Future<void> loadWeeklyReports() async {
    ...
    try {
      ...
      setState(() {
        weeklyReports = List<Map<String, dynamic>>.from(response);
        isLoading = false;
      });
    } catch (e) {
  ...
  Widget _weeklyReportCard(Map<String, dynamic> report, int index) {
        ...
        child: InkWell(
          onTap: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => WeeklyReportDetailScreen(
                  id: id,
                  date: formattedDate,
                  content: content,
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: UniversalAppBar(title: "Archived Weekly Reports"),
      body: SafeArea(
        child: Padding(
          padding: const EdgeInsets.all(AppPadding.medium),
          child: Column(
                ...
                child: isLoading
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _weeklyReportCard(report, index);
                        },
                      ),
              ),
            ],
