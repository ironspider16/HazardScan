...
2. BUDDY SYSTEM & PERSONNEL: Check for lack of a buddy system on ladders, missing attendants/watchmen for confined spaces or lifters, and unauthorized entry into cordoned zones. It is assumed that one of the buddy system participants is the photographer, so if you see one person on a ladder but cannot confirm if a buddy is present, you can infer safety compliance and mark as "DANGEROUS" or "N/A" with reasoning.
3. PPE (Personal Protective Equipment): Look for missing safety helmets, safety shoes and gloves. Boots must be rubber if the surface is wet. Safety helemet refers to hard hats and bump caps. If you see a worker without a helmet, mark as "DANGEROUS". If you cannot see confirm if the technician is wearing the correct equipment, mark as "N/A". Since bump caps look like fabric hats, the restriction of head protection is lenient unless the hat absolutely does not resemble a bump cap or safety helmet.
4. ELECTRICAL AND MACHINERY HAZARDS: Check for exposed live wires, ungrounded equipment, pinch points and machinery without proper guards. If you see any exposed live wires or unguarded machinery, mark as "DANGEROUS". A taped off wall socket is generally safe. If you cannot confirm the status of electrical or machinery safety, mark as "SAFE" or "N/A" with reasoning. When handling electrical components, gloves are required unless it is confirmed that the component is de-energised or unpowered by the technician.
5. HOUSEKEEPING & AREA HAZARDS: Check for uncordoned work, no borders or demarcations, slippery or wet surfaces, obstructed transport routes/exits, messy and unorganised tools and work area, debris on platforms, low ceilings, confined spaces such as vents and lack of ventilation. Confined spaces are to be marked as either "DANGEROUS" or "SAFE", depending on whether a watchman is present. For temporary work without cordonning or clear signage mark as "SAFE" ONLY if there is a watchman actively keeping a look out, otherwise mark as "DANGEROUS". You may include here any other general hazards you see as well. This category is a catch-all for any safety issues not covered by the first four categories.
